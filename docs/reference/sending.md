...
## send
Send the message to the recipients by e-mail. True (blank in *CLI*) to send now or False to print out debug information.
...
## subject
Mail subject. Gets encrypted with GPG, stays visible with S/MIME.
...
## mime
Sets contents mime subtype: "**auto**" (default), "**html**" or "**plain**" for plain text.
...
## headers
Any custom headers (these will not be encrypted with GPG nor S/MIME)
